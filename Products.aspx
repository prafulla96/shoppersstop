<%@ Page Title="" Language="C#" MasterPageFile="~/GuestMasterPage.Master" AutoEventWireup="true" CodeBehind="Products.aspx.cs" Inherits="ShoppersStop.Products" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="margin: 5px 5%; width: 90%; border: 1px solid green">
        <div style="background-color: green; height: 30px; padding: 1%; width: 98%; color: white; font-size: x-large">
            <asp:Label ID="SubCategoryLabel" runat="server"></asp:Label>
        </div>
        <div style="padding: 0.5%; width: 99%">
            <asp:DataList ID="ProductsByCategoryDataList" runat="server" Width="100%" RepeatColumns="4" RepeatDirection="Horizontal">
                <ItemTemplate>
